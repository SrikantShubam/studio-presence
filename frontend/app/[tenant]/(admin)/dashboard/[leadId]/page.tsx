    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-4 px-4 py-5 pb-28 sm:px-6 lg:py-8">
      ...
      <section className="rounded-lg border border-admin-border bg-admin-surface p-4">
        <div className="flex items-start justify-between gap-3">
          ...
          <span className="rounded-lg border border-admin-border bg-admin-bg px-2 py-1 text-xs font-semibold text-admin-muted">{STATUS_LABELS[lead.status].toUpperCase()}</span>
        </div>
      ...
      <section className="rounded-lg border border-admin-border bg-admin-surface p-4"><h2 className="text-base font-semibold text-admin-ink">Message</h2><p className="mt-3 whitespace-pre-wrap text-base text-admin-ink">{lead.message || 'No message was included with this enquiry.'}</p></section>
