...
const contactButtonClass = "!min-h-10 !w-10 !border-0 !bg-transparent !p-0 hover:!bg-transparent cursor-pointer transition-transform duration-150 ease-out hover:scale-105 active:scale-95";
const sourceLabels = {
